...
- **Key Design Decisions**:
    ...
    - **Inventory Table Schema**: Composite primary key (inventory_id, item_id) where inventory_id represents the warehouse_id. This naming convention maintains alignment with ODPEM's historical schema while supporting batch-level inventory tracking.
